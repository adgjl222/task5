    ...
    <div id="view" >
        ...
        <table border="1" align="center"  style="border: 1px solid chartreuse;background:#dddddd;width:38%;height: 380px">
            ...
            <tr align="center">
                <td>姓名</td>
                <td>
                    <c:if test="${(null==user.userName)||(0>=user.userName.length())}">
                        无
                    </c:if>
                    ${user.userName}
                </td>
            ...
            <tr align="center">
                <td>头像</td>
                <td><img border="0" src="${user.salt}" alt="picture" width="108" height="108" class="pimg"></td>
            </tr>
            <tr align="center">
                <td colspan="2" >
        ...
        <form action="/user/u/${user.userName}" id="form1" method="post">
            ...
            <table border="1" align="center"  style="border: 1px solid chartreuse;background:#dddddd;width:38%;height: 380px " >
                ...
                <tr align="center">
                    ...
                    <td>
                        <br>
                        <input id="file" type="file" name="multipartFile" accept="image/jpeg/png" onchange="verificationPicFile(this)" />
                        <br>
                        <br>
